...
// MowayAspiracion.cpp : define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CMowayAspiracionApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CMowayAspiracionApp

CMowayAspiracionApp::CMowayAspiracionApp()
{
...
// El único objeto CMowayAspiracionApp

CMowayAspiracionApp theApp;


// Inicialización de CMowayAspiracionApp

BOOL CMowayAspiracionApp::InitInstance()
{
